...
export interface DieComponent {
  ...
  usedInModels?: string[];    // e.g. ["UNOFLEX-750", "Innoflex-1350"]
  image: string;
  cardDesc: string;
  price: number;
...
export const DIE_COMPONENTS: DieComponent[] = [
  ...
  },
  {
    ...
    price: 0,
    techDesc: {
      "Type": "One Chrome plated Mono Layer Spiral Mandrel Die and lip diameter of as per widths, complete with die adapters and carriage."
    },
    shortDesc: "Basic monolayer die head.",
  },
  {
    id: "die-mono-200",
    name: "Unoflex Die 200 mm",
    dieFamily: "mono",
    diameterMm: 200,
  ...
  },
  {
    ...
    shortDesc: "Large monolayer die head.",
  },
  {
    id: "die-mono-600",
    name: "Unoflex Die 600 mm",
    dieFamily: "mono",
    diameterMm: 600,
